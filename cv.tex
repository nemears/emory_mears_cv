...
\begin{tabular}{p{18.5cm}}
    ...
    \begin{itemize}[noitemsep,topsep=0pt]
      \item Lead a team in expanding a C++ multithreaded model of a system to be used for testing in Linux, she worked on the data structures being used so it could 
